...
local function equipResolved(s, ctx)
    ...
    local mpMap, mpBest, curMP, maxMP, mpFull = nil, nil, nil, nil, false;
    local mpRel, mpUp = {}, {};
    ...
    local PASS = {
        ...
        ['mp-stage'] = function()
            ...
            if mpBest == nil or curMP == nil or maxMP == nil or not mpFull then return; end
            local covered = {};
