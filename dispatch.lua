...
function M.dispatch(event)
    ...
    pcall(function()
        ...
        -- The DECISION RING (v152): append only when the outcome moved.
        recordDecision(event, ctx, planSnap, contest);
    end);
end
