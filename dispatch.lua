        ...
        do
            ...
            for i = #arbOrder, 1, -1 do
                ...
                if claims[cn] ~= nil and cn ~= 'Triggers' then
                    entries[#entries + 1] = { prio = 0, row = rankOf[cn], set = claims[cn] };
                end
