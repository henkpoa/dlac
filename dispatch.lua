        ...
        do
            ...
            for i = #arbOrder, 1, -1 do
                ...
                if cn == 'Locks' and next(M.locks) ~= nil then
                    local held = {};
                    for ls in pairs(M.locks) do held[CANON_OF[ls] or ls] = '(locked)'; end
