...
- **main**: healthy; **1071 tests green + 125 smoke_ui** — current as of 2026-07-17
  ...
  - **Fishing gear system (2026-07-18, engine v64) — the THIRD sibling**
    ...
    **Main** (Halieutica 20945 is a custom Main-slot fishing spear — craft
    ...
    (FishingSkill-major, the UNVERIFIED custom mods 2004/2005 as tiebreak only
    — server-questions §4). Three-way craft/helm/fish arbitration: newest `at`
    wins, ties keep the older. Data: `data/fishdb.lua` generated by
